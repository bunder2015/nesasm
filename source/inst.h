...
struct t_opcode base_inst[57] = {
	{NULL, "ADC", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0x61, 0},    //BJP removed ZP_IND mode
	{NULL, "AND", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0x21, 0},    //BJP removed ZP_IND mode
	...
	{NULL, "CMP", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0xC1, 0},    //BJP removed ZP_IND mode
	...
	{NULL, "EOR", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0x41, 0},    //BJP removed ZP_IND mode
	...
	{NULL, "LDA", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0xA1, 0},    //BJP removed ZP_IND mode
	...
	{NULL, "ORA", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0x01, 0},    //BJP removed ZP_IND mode
	...
	{NULL, "SBC", class4, IMM|ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0xE1, 0},    //BJP removed ZP_IND mode
	{NULL, "SEC", class1, 0, 0x38, 0},
	{NULL, "SED", class1, 0, 0xF8, 0},
	{NULL, "SEI", class1, 0, 0x78, 0},
	{NULL, "STA", class4, ZP|ZP_X|ZP_IND_X|ZP_IND_Y|ABS|ABS_X|ABS_Y, 0x81, 0},    //BJP removed ZP_IND mode
...
struct t_opcode base_pseudo[79] = {
	...
	{NULL, "SRAM",	   do_section, PSEUDO, P_SRAM,	  S_SRAM},
